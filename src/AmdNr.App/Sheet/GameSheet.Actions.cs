// What the sheet does to a game: the pre-flight, the install, the uninstall, and the smaller things
// around them -- play, open the folder, point at another executable, take the row out, report.
